            ...
            for n in range(0,self.actors):
                ...
                for t in range(self.max_timesteps):
                    ...
                    if (done==True or t==self.max_timesteps) and training == True:
                        ...
                        advantages.append(agent.calc_advantage(values, rewards, 0, t))
                        gradients.append()
...
class PPO_Agent:
    ...
    def select_action(self,state):
        ...
        probs = policy_probabilities(logit)
    ...
    def nn_model(self,state_size,output_size):
        ...
        layer_four = Dense(output_size, activation="linear", kernel_initializer='random_normal',bias_initializer='zeros')(layer_three)
